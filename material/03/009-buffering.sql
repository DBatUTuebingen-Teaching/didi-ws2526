...
.shell sync; sudo purge

-- Attach to TPC-H database of scale factor 10 (sf = 10), table
-- lineitem has cardinality 60 million rows. 'tpch.db' is hosted
-- on the DB group's web server: need to use a slow HTTPS connection
-- to access the table data:

ATTACH 'https://db.cs.uni-tuebingen.de/staticfiles/tpch.db';
USE tpch;
